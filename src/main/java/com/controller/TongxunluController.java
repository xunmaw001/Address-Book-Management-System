    ...
    */
    ...
    public R save(@RequestBody TongxunluEntity tongxunlu, HttpServletRequest request){
        ...
        Wrapper<TongxunluEntity> queryWrapper = new EntityWrapper<TongxunluEntity>()
            ...
            .eq("tongxunlu_biaoqian", tongxunlu.getTongxunluBiaoqian())
            .eq("tongxunlu_gongsi", tongxunlu.getTongxunluGongsi())
            .eq("tongxunlu_bumen", tongxunlu.getTongxunluBumen())
            .eq("tongxunlu_zhiwei", tongxunlu.getTongxunluZhiwei())
            .eq("tongxunlu_xianzhuzhi", tongxunlu.getTongxunluXianzhuzhi())
...
//                            tongxunluEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
...
//                            tongxunluEntity.setTongxunluBiaoqian(data.get(0));                    //朋友标签 要改的
//                            tongxunluEntity.setTongxunluGongsi(data.get(0));                    //所在公司 要改的
//                            tongxunluEntity.setTongxunluBumen(data.get(0));                    //所在部门 要改的
//                            tongxunluEntity.setTongxunluZhiwei(data.get(0));                    //职位 要改的
//                            tongxunluEntity.setTongxunluXianzhuzhi(data.get(0));                    //现住址 要改的
//                            tongxunluEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
