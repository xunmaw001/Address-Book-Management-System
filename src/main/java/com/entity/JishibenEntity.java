 ...
 */
@TableName("jishiben")
public class JishibenEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Jishiben{" +
            "id=" + id +
            ", yonghuId=" + yonghuId +
            ", jishibenName=" + jishibenName +
            ", jishibenTypes=" + jishibenTypes +
            ", jishibenContent=" + jishibenContent +
