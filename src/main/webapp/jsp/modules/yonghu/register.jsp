...
<body style="background-image:url('/tongxunluguanli/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>用户编号</label>
                                    <input id="yonghuUuidNumber" name="yonghuUuidNumber" class="form-control"
                                           placeholder="用户编号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>用户姓名</label>
