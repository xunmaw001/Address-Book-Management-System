            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">通讯录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="tongxunluName" name="tongxunluName" class="form-control"
                                               v-model="ruleForm.tongxunluName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="tongxunluPhone" name="tongxunluPhone" class="form-control"
                                               v-model="ruleForm.tongxunluPhone" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>朋友照片</label>
                                    <img id="tongxunluPhotoImg" width="100" height="100">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>朋友电子邮箱</label>
                                        <input style="width: 450px" id="tongxunluEmail" name="tongxunluEmail" class="form-control"
                                               v-model="ruleForm.tongxunluEmail" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="tongxunluBiaoqian" name="tongxunluBiaoqian" class="form-control"
                                               v-model="ruleForm.tongxunluBiaoqian" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="tongxunluGongsi" name="tongxunluGongsi" class="form-control"
                                               v-model="ruleForm.tongxunluGongsi" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="tongxunluBumen" name="tongxunluBumen" class="form-control"
                                               v-model="ruleForm.tongxunluBumen" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="tongxunluZhiwei" name="tongxunluZhiwei" class="form-control"
                                               v-model="ruleForm.tongxunluZhiwei" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="tongxunluXianzhuzhi" name="tongxunluXianzhuzhi" class="form-control"
                                               v-model="ruleForm.tongxunluXianzhuzhi" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.tongxunluContent != null && ruleForm.tongxunluContent != 'null' && ruleForm.tongxunluContent != '') {
            var tongxunluContentUeditor = UE.getEditor('tongxunluContentEditor');
                tongxunluContentUeditor.ready(function () {
                    ...
                    tongxunluContentUeditor.setDisabled('fullscreen');
            });
        }
    }
